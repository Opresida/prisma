...
- **2026-07-20** — Rota **`/ciencia`**: documento de fundamentação científica dos 4 instrumentos (origem, autores, pontuação, fontes oficiais — 3 de 4 de Cambridge), no papel timbrado do Prisma; **OG exclusivo** (`og-ciencia.png`); link no card de boas-vindas. Copy do welcome ajustada (sinaliza cobertura por idade).
